...
public interface MobileMapper {
    ...
    List<BizCollaboration> getCollaborations(Integer category, int offset, int size);
    ...
    BizCollaboration findByCollaborationId(@Param("collaborationId") Long collaborationId);
}
